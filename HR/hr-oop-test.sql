...
INSERT INTO professions (profession) VALUES ("Labo");
...
INSERT INTO accounts (username, password_hash, account_type) VALUES ("user7", "14427c2bf6d1e9abe854993d4f5ed1c1f3fb7896", "Company");
INSERT INTO accounts (username, password_hash, account_type) VALUES ("user8", "14427c2bf6d1e9abe854993d4f5ed1c1f3fb7896", "Company");
...
INSERT INTO employees VALUES ((SELECT id FROM accounts WHERE username = "user1"), "John", "James", "Male", STR_TO_DATE('01/5/1973','%d/%m/%Y'), 
			"Software Developer", "Phsychologist", "599131415", "john.doe@gmail.com", 
...
INSERT INTO employees VALUES ((SELECT id FROM accounts WHERE username = "user2"), "Mark", "Robertson", "Male", STR_TO_DATE('04/9/1980','%d/%m/%Y'), 
			"Software Developer", "../Images/avatar.png", "599111015", "mark.robertson@gmail.com", 
            "Tbilisi", "I am a highly competent IT professional with a proven track record in designing websites, networking and managing databases. I have strong technical skills as well as excellent interpersonal skills, enabling me to interact with a wide range of clients. I am eager to be challenged in order to grow and further improve my IT skills. My greatest passion is in life is using my technical know-how to benefit other people and organisations.", "../Images/avatar.png", false);
INSERT INTO employees VALUES ((SELECT id FROM accounts WHERE username = "user3"), "Albert", "Knopfler", "Male", STR_TO_DATE('02/9/1963','%d/%m/%Y'), 
			"Doctor", "Teacher", "597552951", "albert.knopfler@gmail.com", 
...
INSERT INTO employees VALUES ((SELECT id FROM accounts WHERE username = "user4"), "Mary", "Simpson", "Female", STR_TO_DATE('08/7/1989','%d/%m/%Y'), 
			"Teacher", "Linguistics", "593058950", "mary.simpson@gmail.com", 
...
INSERT INTO employees VALUES ((SELECT id FROM accounts WHERE username = "user5"), "Maggie", "Hart", "Female", STR_TO_DATE('19/2/1990','%d/%m/%Y'), 
			"Chef", "minor", "59326665", "maggie.hart@gmail.com", 
...
INSERT INTO vacancies (company_id, heading, description, expiry_date, emp_type, qualification_1, qualification_2, qualification_3, profession, position, years_of_experience, location, degree) VALUES (7, "Software Engineer", "Google's software engineers develop the next-generation technologies that change how billions of users connect, explore, and interact with information and one another. Our products need to handle information at massive scale, and extend well beyond web search. We're looking for engineers who bring fresh ideas from all areas, including information retrieval, distributed computing, large-scale system design, networking and data storage, security, artificial intelligence, natural language processing, UI design and mobile; the list goes on and is growing every day. As a software engineer, you will work on a specific project critical to Google’s needs with opportunities to switch teams and projects as you and our fast-paced business grow and evolve. We need our engineers to be versatile, display leadership qualities and be enthusiastic to take on new problems across the full-stack as we continue to push technology forward.", 
                        ...
                        "Software Engineer", "Software Engineer", 1, "Tbilisi", "Bachelor");
INSERT INTO vacancies (company_id, heading, description, expiry_date, emp_type, qualification_1, qualification_2, qualification_3, profession, position, years_of_experience, location, degree) VALUES (7, "Telecommunications", "The Google Cloud Platform team helps customers transform and evolve their business through the use of Google’s global network, web-scale data centers and software infrastructure. As part of an entrepreneurial team in this rapidly growing business, you will help shape the future of businesses of all sizes use technology to connect with customers, employees and partners. As an Enterprise Account Manager, you'll advocate for the Cloud Platform, promoting technology for business innovation. You'll introduce Google Cloud Platform to our customers, drive awareness in the developer and startup community and leverage and build the Google Cloud Platform partner ecosystem.", 
...
INSERT INTO vacancies (company_id, heading, description, expiry_date, emp_type, qualification_1, qualification_2, qualification_3, profession, position, years_of_experience, location, degree) VALUES (8, "Software Engineering Intern", "Much did had call new drew that kept. Limits expect wonder law she. Now has you views woman noisy match money rooms. To up remark it eldest length oh passed. Off because yet mistake feeling has men. Consulted disposing to moonlight ye extremity. Engage piqued in on coming. ", 
                        ...
                        "Software development experience in one or more general purpose programming languages.", 
                        "Working proficiency and communication skills in verbal and written English.", 
                        "Software Engineer", "Software Engineer", 1, "Gori", "Bachelor");
INSERT INTO vacancies (company_id, heading, description, expiry_date, emp_type, qualification_1, qualification_2, qualification_3, profession, position, years_of_experience, location, degree) VALUES (8, "Chef", "She suspicion dejection saw instantly. Well deny may real one told yet saw hard dear. Bed chief house rapid right the. Set noisy one state tears which. No girl oh part must fact high my he. Simplicity in excellence melancholy as remarkably discovered. Own partiality motionless was old excellence she inquietude contrasted. Sister giving so wicket cousin of an he rather marked. Of on game part body rich. Adapted mr savings venture it or comfort affixed friends.", 
...
INSERT INTO vacancies (company_id, heading, description, expiry_date, emp_type, qualification_1, qualification_2, qualification_3, profession, position, years_of_experience, location, degree) VALUES (9, "Engineer", "You disposal strongly quitting his endeavor two settling him. Manners ham him hearted hundred expense. Get open game him what hour more part. Adapted as smiling of females oh me journey exposed concern. Met come add cold calm rose mile what. Tiled manor court at built by place fanny. Discretion at be an so decisively especially. Exeter itself object matter if on mr in.", 
                        ...
                        "Software development experience in one or more general purpose programming languages.", 
                        "Working proficiency and communication skills in verbal and written English.", "Engineer", "Engineer", 4, "Tbilisi", "Master");
INSERT INTO vacancies (company_id, heading, description, expiry_date, emp_type, qualification_1, qualification_2, qualification_3, profession, position, years_of_experience, location, degree) VALUES (9, "Engineer", "Unpleasant nor diminution excellence apartments imprudence the met new. Draw part them he an to he roof only. Music leave say doors him. Tore bred form if sigh case as do. Staying he no looking if do opinion. Sentiments way understood end partiality and his.", 
                        ...
                        "Software development experience in one or more general purpose programming languages.",
                        "Working proficiency and communication skills in verbal and written English.", "Engineer", "Engineer", 2, "Tbilisi", "Bachelor");
...
INSERT INTO applicants (vacancy_id, employee_id) VALUES (1, 1); 
