...
public class VacancyEditServlet extends HttpServlet {
	...
	public Vacancy factor(int id, String heading, String position, String description, String jobType, int companyId,
	 ...
	 *      response)
	 *      Gets new Parameters for vacancy
	 *      Updates all information about vacancy from base
	 *      Returns information to caller with JSON Object
	 */
